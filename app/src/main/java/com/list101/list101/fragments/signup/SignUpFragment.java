...
public class SignUpFragment extends BaseSignUpFragment<SignUpView, SignUpPresenter> implements SignUpView {
    ...
    public void doInjections() {
        List101App.getDependenciesScopesController().createSignUpComponent(fragmentRxLifecycle);
    }

    public void releaseComponent() {
        List101App.getDependenciesScopesController().releaseSignUpComponent();
    }

    @Override
    @NonNull
    public SignUpPresenter createPresenter() {
        return List101App.getDependenciesScopesController().getSignUpComponent().getSignUpPresenter();
    }
